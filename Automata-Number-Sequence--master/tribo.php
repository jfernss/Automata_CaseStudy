<!-- filepath: c:\Xampp\htdocs\Automata-Number-Sequence--master\Automata-Number-Sequence--master\tribo.php -->
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
  ...
  <body>
    <div class="card position-absolute top-0 start-50 translate-middle-x" style="width: 1200px; margin-top: 150px;">
        <div class="card-body">
           <h2 class="fw-bold">Tribonacci Sequence</h2>
           <p class="lh-base fst-italic">The Tribonacci sequence is a set of integers (the Tribonacci numbers) that starts with a zero, a one, and another one. Each following number in the sequence is the sum of the preceding three numbers, leading to a more rapidly increasing sequence than Fibonacci.</p>
        </div>
    </div>
    ...
    <?php if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['numTerms'])): ?>
        <?php
            ...
            ?>
            <div id="tribonacciCard" class="card position-absolute top-0 start-50 translate-middle-x" style="width: 1200px; margin-top: 425px;">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <h2 class="fw-bold">The Tribonacci Numbers : </h2>
                        <h2 class="fw-bold pt-1 ps-1"><?php echo $numTerms; ?> terms</h2>
                    </div>
                    
                    <p class="fs-4 mb-0"><?php echo implode(', ', $tribonacci); ?></p>
                    <div class="mt-4 d-flex justify-content-end align-items-center">
                        <p class="fw-bold fs-4 mb-0 me-3">Try again?</p>
                        <form method="POST" action="" class="d-flex">
                            <button type="submit" name="tryAgain" class="btn btn-warning btn-lg me-2">YES</button>
